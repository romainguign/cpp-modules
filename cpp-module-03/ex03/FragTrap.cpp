...
{
    if (!this->_hitPoint)
		std::cout << this->_name << " does not have enough hit point to request High Fives" << std::endl;
	else if (!this->_energyPoint)
		std::cout << this->_name << " does not have enough energy point to request High Fives" << std::endl;
    else
	{
